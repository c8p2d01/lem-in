...
//			{
//				ft_linked_to = ft_otherside((t_link *)n_links->content, q_nodes->content);
//				if (((t_content *)ft_linked_to->content)->level == 0 && 
//					(((t_info *)((t_link *)n_links->content)->info)->flow == 0 ||
//					!counter_flow(q_nodes->content, n_links->content)))
//				{
//					new_q_node = ft_lstnew(ft_linked_to);
//					if (!new_q_node)
//					{
...
//			{
//				ft_linked_to = ft_otherside((t_link *)river_links->content, river->content);
//				low_level = ((t_content *)ft_linked_to->content)->level;
...
//		}
//		ft_linked_to = ft_otherside(low_link, river->content);
...
//		}
//		new_river_node = ft_lstnew(ft_linked_to);
//		ft_lstadd_back(&river, new_river_node);
//		river = river->next;
//	}
//	if (net->pathed)
